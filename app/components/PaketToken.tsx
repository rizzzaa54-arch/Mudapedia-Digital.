...
export default function PaketToken() {
  ...
  // Mengambil daftar paket langsung dari file JSON aktif (id.json / en.json)
  const currentPackages = t.paket?.[activeNetwork] || t.paket?.solana || [];
                  ...
                  >
                    ...
                    <div className="flex-grow">
                      <div className="text-center mb-6">
                        ...
                        <span className="text-xs text-gray-400">{t.paket.perProject}</span>
                      </div>
